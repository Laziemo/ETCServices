...
let broadcast = (signed_tx)=>{
  return new Promise((resolve,reject)=>{
    try{
      web3.eth.sendSignedTransaction(signed_tx.toString('hex'))
      .on('receipt', (receipt)=>{
        if(receipt!=null){
...
//===exports=====-==================================================|
module.exports={new_account,account_from_key,block_height,sign,broadcast,get_balance,get_tx,get_tx_receipt};
//===FIN=====-==================================================|
